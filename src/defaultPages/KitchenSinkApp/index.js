          ...
          <div style={{ "margin": "auto" }}>
            ...
            <div style={{ "display": "flex", "width": "100%", "flexWrap": "wrap", "margin": "auto" }}>
              <div className="userSelector">
                ...
                <p style={{ "margin": "auto" }}><a onClick={()=>this.login('superhero5')} href="#"> superhero1</a></p>
              </div>
              <div className="userSelector">
